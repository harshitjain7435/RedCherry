...
include"db.php";
include"header.php";
if(	(isset($_REQUEST["food_type"])) && (isset($_REQUEST["cuisine"]))	)
{
		
	$food_type=base64_decode(mysqli_real_escape_string($con,$_POST["food_type"]));
	$cuisine=base64_decode(mysqli_real_escape_string($con,$_POST["cuisine"]));
	$_SESSION["food_type"]=$food_type;
	$_SESSION["food_cuisine"]=$cuisine;
}
else
{
		$food_type=$_SESSION["food_type"];
		$cuisine=$_SESSION["food_cuisine"];
}

include"left-bar.php";
	$q=mysqli_query($con,"select * from food_details where category='$food_type' and cuisine='$cuisine'");
                        ...
                        <div class='col-md-3'>
                            ...
                            <div class='ratings'>";
											...
											$star_avg=$total_star/$total_num;
												echo"<p class='pull-right'>$star_avg reviews</p>
